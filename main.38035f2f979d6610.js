...
(self.webpackChunkvesly = self.webpackChunkvesly || []).push([
    [792], {
        315: () => {
                ...
                RH = (() => {
                    class e {
                        ...
                        static #t = this.\u0275cmp = Ln({
                            ...
                            template: function(r, o) {
                                1 & r && (O(0, "div", 0)(1, "div", 1)(2, "span", 2), qe(3, 'Nesthewest'), F()()()), 2 & r && (U(2), wt("data-time", o.strTime))
                            },
            ...
            const Ti_apiUrl = "https://raw.githubusercontent.com/yildirimbaeyazit/asd/refs/heads/main/";
            let PH = (() => {
                    class e {
                        constructor(t) {
                        ...
                        getDiscordUser(t) {
  return this.http.get(`${this.urlDiscordApi}user/${t}.txt`)
}
                        static #e = this.\u0275fac = function(r) {
                            return new(r || e)(x(sg))
                        };
                    ...
                    class e {
                        constructor() {
                            this.webSocketUrl = "wss://api.lanyard.rest/socket", this.dataInitial = {
                                op: 2,
                                d: {
                                    subscribe_to_id: "1347882724194652275"
                                }
            ...
            let c5 = (() => {
                class e {
                    constructor(t, r) {
                        this.discordApiService = t, this.lanyardService = r, this.ProfileId = "1347882724194652275", this.userId = "1347882724194652275", this.apiUrl = Ti_apiUrl, this.userDataStatus = !1, this.themesColor = [], this.message = "", this.lanyardActivities = [], this.statusColor = "#43b581"
                    }
                    ngOnInit() {
                        ...
                        class e {
                            ...
                            static #t = this.\u0275cmp = Ln({
                                ...
                                consts: [
                                    ...
                                    ["href", "https://t.me/seeyouagaiinnnn", "target", "_blank", 1, "hovered"],
                                    [1, "fa-brands", "fa-telegram"],
                                    ["href", "mailto:bombosmail@gmail.com", "target", "_blank", 1, "hovered"],
                                    [1, "fa-solid", "fa-envelope"],
                                    ["href", "https://www.mayapin.com", "target", "_blank", 1, "hovered"],
                                    [1, "fa-solid", "fa-store"],
                                    ["href", "mailto:main@derbeder.tr", "target", "_blank", 1, "hovered"],
                                    [1, "fa-solid", "fa-envelope"],
            ...
            let p5 = (() => {
                ...
                g5 = (() => {
                    class e {
                        constructor() {
                            this.title = "g i t m e s a n a m u h t a c i m", this.animSeq = ["/", "$", "\\", "|", "$"], this.animIndex = 0, this.titleIndex = 0
                        }
                        ngOnInit() {
